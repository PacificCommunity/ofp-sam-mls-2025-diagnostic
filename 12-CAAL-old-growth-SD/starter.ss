...
-1 # min year for sdreport outputs (-1 for styr); #_1950
-2 # max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2023
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1737582625
